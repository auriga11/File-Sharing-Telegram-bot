...
SHORTLINK_API_KEY = os.environ.get("SHORTLINK_API_KEY", "b3bcb9ce632a8cd2b5d944313f6a2b1ad0ae4c57")
...
#UPI QR CODE IMAGE
UPI_IMAGE_URL = os.environ.get("UPI_IMAGE_URL", "https://tinyurl.com/f4tnzdke")
